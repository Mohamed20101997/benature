                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('shippings.index')}}"> @lang('admin/shipping.shippings') </a>
                                </li>
                                <li class="breadcrumb-item active">  @lang('admin/shipping.edit') - {{$shipping -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  @lang('admin/shipping.editshipping') </h4>
                                        ...
                                        <form class="form" action="{{route('shippings.update',$shipping->id)}}"
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> @lang('admin/shipping.update')
                                                </button>
                                            </div>
                                    </div>
                                    </form>
