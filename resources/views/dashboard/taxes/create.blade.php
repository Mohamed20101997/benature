                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('taxes.index')}}">@lang('admin/taxe.taxes') </a></li>
                                <li class="breadcrumb-item active"> @lang('admin/taxe.addtaxes') </li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  @lang('admin/taxe.addtaxes') </h4>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="la la-check-square-o"></i> @lang('admin/taxe.create')
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
